...
const bookRoutes = require('./book_routes') // Require in book_routes as bookRoutes
const commentRoutes = require('./comment_routes') // Require in comment_routes as commentRoutes
